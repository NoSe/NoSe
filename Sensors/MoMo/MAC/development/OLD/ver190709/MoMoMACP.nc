...
/**************************************************/
    ...
    inline void makePktSync() {
        ...
        call RadioControl.setRxSleepInterval( &msg_sync_, MM_ALWAYS_ON );
    }
...
/**************************************************/
    ...
    task void endContentionReceiverSuccess() {
        ...
        call RadioControl.leaveContention();
    }
    ...
    task void endContentionSenderSuccess() {
        ...
        call RadioControl.stopContention();
    }
...
/**************************************************/
    ...
    command error_t Send.send(message_t* msg, uint8_t len) {
        ...
        if( call RadioControl.startContention() != SUCCESS )
            return FAIL;
...
/**************************************************/
    ...
    event message_t* SubReceive.receive(message_t* msg, void* payload, uint8_t len) {
        ...
        if ( call RadioControl.enterContention() == SUCCESS ) {
            ...
            if ( call AMPacket.destination( msg_recv_data_ ) == AM_BROADCAST_ADDR ) {
                ...
                slot_time = ((int32_t)( call RadioControl.getNodeSleepDuration() ) << 5);
                call Leds.led0On();
            } else {
                mac_state_ = MT_MM_TX_ACK;
            }
